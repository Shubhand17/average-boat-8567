    ...
    return (
        ...
        <Box width={"100%"} backgroundColor="white" position={"sticky"} top="0" zIndex={"10"} >
            <HStack width={"80%"} margin={"auto"} height="80px" justifyContent={"space-around"} >
                <Link to="/">
                    <Image width="40%" src="https://i.ibb.co/XFyZsGS/Michelle-2.png" alt="" />
                ...
                <HStack w="20%" h="30px">
                    <Link to="/signup">
                        <HStack margin={"auto"} width={"fit-content"} justifyContent="center"  >
                            ...
                            <Text fontSize={"14px"}>{name ? name : "Account"}</Text>
